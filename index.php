    ...
    <header>
        <div class="container header__container">
            ...
            <div class="header__right">
                ...
                <h1>اتوکد چیست؟</h1>
                <p>
                    نرم افزاری برای طراحی در زمینه های مختلف می باشد و کاربر د های گوناگونی در رشته هایی همچو ن ؛
معماری، عمران، طراحی داخلی، طراحی  صنعتی ، شهری  ، برق ، مکانیک و...که کاربران
دراین محیط امکان استفاده ازمحیط های دو بعدی و سه بعدی را دارند Autodesk auto cad
و به فراخور نیاز میتوانند از این امکانات بهرمند شوند .
                </p>
