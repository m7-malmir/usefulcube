        ...
        <div class="container header__container">
            <div class="header__left">
                ...
                <div class="header__image-lg">
                    <img src="./img/transparent1-3.png" alt="">
                </div>
                <!--header__image-lg-->
...
رشته هایی همچون ؛ معماری ، عمران ، طراحی داخلی ، طراحی صنعتی ، شهری و منظر، برق ، مکانیک و... دارد و کاربران در این محیط امکان استفاده از محیط های دو بعدی و سه بعدی را دارند و به فراخور نیاز می توانند از امکانات Autodesk auto cad بهره مند شوند.
    ...
    <section id="about">
        <div class="container about__container">
            ...
            <div class="about__right">
                ...
                <p>
                در دوره ای قرار داریم که تکنولوژی سهم و تاثیر بسزایی در زندگی هر فرد دارد و من بیشتر از همیشه با انگیزه و پرتلاش با مهارت هایی که طی سال های تحصیلی و کاری در زمینه هایی همچون طراحی و نظارت معماری ، بازدید از پروژه های اجرایی ، سابقه همکاری با شهرداری ها و شرکت های گوناگون به دست آورده ام امیدوارم بتوانم سهم کوچک مفیدی در جهت هرچه بهتر آموزش و ارائه آن ایفا نمایم و اتفاق های مثبت و خوبی برای خود و همراهانم رقم بزنم .
                </p>
            </div>
            <!--about right-->
        </div>
    ...
    <section id="gallery">
        <div class="container gallery__container swiper mySwiper">
            ...
            <!--gallery__head-->
            <p>
            قصد داریم که در این نرم افزار به ابزارهای پر کاربرد ومفید آن برای انجام هرچه بهتر پروژه ها بپردازیم به گونه ای که بعد از اتمام دوره آموزشی توانایی کار واستفاده راحت از ابزارهای نرم افزار اتوکد را در پروژه های شخصی خود در سطح خوبی به دست آورید.
            </p>
    ...
    <section id="exhibition">
        <div class="container exhibition__container">
            ...
            <div class="exhibition__haed">
                <p>
                برای ارتباط هرچه بهتر در جهت یادگیری و تعامل در فضای مجازی با یک دیگر بر آن شدیم تا تجربیات مفید خود را در قالب یک وب سایت تحت عنوان <a href="https://Usefulcube.com">Usefulcube.com</a> یا همان( مکعب مفید ) به شما عزیزان ارائه دهیم ، قطعا همراهی شما در این مسیر باعث انگیزه و دل گرمی ما در جهت تولید محتوایی هرچه مفید تر یاری خواهد کرد .
                </p>
